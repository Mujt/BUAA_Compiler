...
int Tokenpoint=0,num=0,Strpoint=0;
char str[strsize];
FILE *fp,*out;
char *currchar;//当前字符
...
enum reserv ksy[keysize],sps[specsymsize],idcss[4],sy;
int isSpace(){
    return *currchar==' ';
}
int isNewline(){
